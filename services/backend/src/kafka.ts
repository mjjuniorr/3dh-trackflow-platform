...
const rawMessageSchema = z.object({
  ...
  vehicle_type: z.enum(["motorcycle", "car", "boat", "airplane", "bus"]).optional(),
  vehicleType: z.enum(["motorcycle", "car", "boat", "airplane", "bus"]).optional(),
...
function normalizeLocationMessage(raw: unknown) {
  ...
  return locationMessageSchema.safeParse({
    ...
    phone: value.phone,
    vehicle_type: value.vehicle_type ?? value.vehicleType,
