...
export function getPermissions() {
  ...
  return payload.role === "admin" || payload.role === "platform_owner"
    ? ["trackflow:view", "trackflow:manage-delivery-people", "trackflow:create-public-links", "trackflow:revoke-public-links", "trackflow:manage-settings", "trackflow:manage-deliveries", "trackflow:view-reports", "trackflow:admin"]
